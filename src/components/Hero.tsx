...
export default function Hero({ onBookCall }: HeroProps) {
  return (
    <div className="min-h-[70vh] flex items-center pt-12 bg-gradient-to-b from-blue-50 via-white to-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
            <button onClick={onBookCall} className="btn btn-primary w-full sm:w-auto">
